...
Components Used:
ESP32 Microcontroller: Serves as the main processing unit and handles Bluetooth communication.
MPU6050 Accelerometers: Three accelerometers are used to capture fetal movements.
TCA9548A I2C Multiplexer: Allows multiple I2C devices to communicate with the ESP32.
Bluetooth Module: Integrated within the ESP32 to transmit data to a mobile application.
Buzzer: Provides audible alerts for abnormal conditions.
3.7V Batteries and BMS Board: Power the system and manage battery health.
MIT App Inventor: Used to develop the mobile application that receives and displays fetal movement data.
